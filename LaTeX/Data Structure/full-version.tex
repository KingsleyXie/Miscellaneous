...
\lstdefinestyle{monospaced}{
	basicstyle=
		\def\fvm@Scale{0.8}
		\fontfamily{fvm}\selectfont,
	tabsize=4
}
\lstdefinestyle{cpp-orange-hl}{
	basicstyle=
		\def\fvm@Scale{0.8}
		\fontfamily{fvm}\selectfont,
	language=C++,
...
\noindent texttt effect: \texttt{while (true) i++;}

\noindent lstinline effect: \lstinline[style=monospaced]{while (true) i++;}

\noindent lstinline with highlight option: \lstinline[style=cpp-orange-hl]{while (true) i++;}
